//<summary>
//  Title   : A control used to display and edit the contents of an ItemValue object.
...
namespace CAS.Lib.OPCClientControlsLib
{
  ...
  /// A control used to display and edit the contents of an ItemValue object.
  /// </summary>
  public class ItemValueEditCtrl: System.Windows.Forms.UserControl, IEditObjectCtrl<OpcDa::ItemValue>
  {
    ...
    private CAS.Lib.OPCClientControlsLib.EnumCtrl QualityBitsCTRL;
    private CAS.Lib.OPCClientControlsLib.EnumCtrl LimitBitsCTRL;
    ...
    public void SetDefaults()
    {
      ...
      QualityBitsCTRL.Value = OpcDa::qualityBits.bad;
      LimitBitsCTRL.Value = OpcDa::limitBits.none;
    ...
    /// </summary>
    public OpcDa::ItemValue Get()
    {
      OpcDa::ItemValue item = new OpcDa::ItemValue( m_identifier );
      item.ItemName = ItemNameTB.Text;
      item.ItemPath = ItemPathTB.Text;
      item.Value = ( ValueSpecifiedCB.Checked ) ? ValueCTRL.Value : null;
      // set quality fields.
      item.Quality = OpcDa::Quality.Bad;
      if ( QualitySpecifiedCB.Checked )
      {
        OpcDa::Quality quality = new OpcDa::Quality();
        quality.QualityBits = (OpcDa::qualityBits)QualityBitsCTRL.Value;
        quality.LimitBits = (OpcDa::limitBits)LimitBitsCTRL.Value;
