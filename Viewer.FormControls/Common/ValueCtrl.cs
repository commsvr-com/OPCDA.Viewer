...
namespace CAS.Lib.OPCClientControlsLib
{
  ...
  public class ValueCtrl: System.Windows.Forms.UserControl
  {
    ...
    private CAS.Lib.OPCClientControlsLib.DataTypeCtrl DataTypeCTRL;
    ...
    private void InitializeComponent()
    {
      ...
      this.DataTypeCTRL = new CAS.Lib.OPCClientControlsLib.DataTypeCtrl();
    ...
    public object Get()
    {
      ...
      if ( m_type == typeof( System.DateTime ) )
      {
        System.DateTime datetime = DateTimeCTRL.Value;
        if ( datetime == DateTimeCTRL.MinDate )
          return System.DateTime.MinValue;
        return datetime;
      }

      if ( m_type != null && m_type.IsArray )
        return Opc.Convert.ChangeType( m_value, m_type );

      //Opc.Convert empty string to null for all types other than strings.
      string value = ValueTB.Text;
      if ( m_type != typeof( string ) && value != null && value == "" )
        value = null;

      //Opc.Convert string to type (null creates a default value for the type).
    ...
    public void Set( object value, bool readOnly )
    {
      ...
      if ( !m_readOnly && m_type == typeof( System.DateTime ) )
      {
        System.DateTime datetime = (System.DateTime)m_value;
      ...
      if ( m_type.IsArray )
      {
        ValueTB.Text = (string)Convert.ChangeType( m_value, typeof( string ) );
        ValueTB.Visible = true;
        EditPN.Visible = true;
        DateTimeCTRL.Visible = false;
        return;
