...
using CAS.OPCViewer.Properties;
using OpcDa = Opc.Da;
...
namespace CAS.OPCViewer
{
  ...
  [GuidAttribute( "BFDDBFB8-332E-473b-9FDA-3621699BD28B" )]
  public partial class MainFormV2008: Form
  {
    ...
    {
      //dcomcnfg
      CAS.Lib.RTLib.Processes.RunMethodAsynchronously runasync =
        new CAS.Lib.RTLib.Processes.RunMethodAsynchronously( delegate( object[] o )
      {
        try
        {
