...
namespace CAS.Lib.OPCClientControlsLib
{
	...
	/// </summary>
	public interface IEditObjectCtrl<GenericType>
	{
		/// <summary>
	...
	/// </summary>
	public class EditObjectListDlg<GenericType> : System.Windows.Forms.Form
	{
      ...
      this.ButtonsPN.Controls.Add( this.CounterLB );
      ...
      this.SelectorSB.Location = new System.Drawing.Point( 0, 0 );
      ...
      // SelectorPN
      // 
      this.SelectorPN.Controls.Add( this.SelectorSB );
      ...
      this.Controls.Add( this.SelectorPN );
      ...
      this.HelpButtonClicked += new System.ComponentModel.CancelEventHandler( this.EditObjectListDlg_HelpButtonClicked );
      ...
      this.ResumeLayout( false );
		...
		/// </summary>
    protected IEditObjectCtrl<GenericType> m_control = null;
		...
		/// </summary>
    public ArrayList ShowDialog( GenericType[] objects )
		{
		...
		/// </summary>
    public ArrayList ShowDialog( GenericType[] objects, bool fixedLength )
		{
			...
			m_control.Set((GenericType)m_objects[m_index]);
    ...
    /// <summary>
    /// Handles the HelpButtonClicked event of the EditObjectListDlg control.
    /// </summary>
    /// <param name="sender">The source of the event.</param>
    /// <param name="e">The <see cref="System.ComponentModel.CancelEventArgs"/> instance containing the event data.</param>
    private void EditObjectListDlg_HelpButtonClicked( object sender, CancelEventArgs e )
    {
