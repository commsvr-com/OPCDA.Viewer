...
namespace CAS.Lib.OPCClientControlsLib
{
  ...
  /// </summary>
  public delegate void BrowseFiltersChangedCallback( OpcDa::BrowseFilters filters );
  ...
  public class BrowseFiltersDlg: System.Windows.Forms.Form
  {
    ...
    private CAS.Lib.OPCClientControlsLib.PropertyFiltersCtrl PropertyFiltersCTRL;
    ...
    private CAS.Lib.OPCClientControlsLib.EnumCtrl BrowseFilterCTRL;
    ...
    private void InitializeComponent()
    {
      ...
      this.PropertyFiltersCTRL = new CAS.Lib.OPCClientControlsLib.PropertyFiltersCtrl();
      this.BrowseFilterCTRL = new CAS.Lib.OPCClientControlsLib.EnumCtrl();
      ...
      this.MaxElementsReturnedCTRL.Maximum = new decimal( new int[] {
            10000,
            0,
            0,
            0} );
      ...
      this.PropertyFiltersCTRL.PropertyIDs = new OpcDa::PropertyID[ 0 ];
    ...
    private void ApplyChanges()
    {
      ...
      filters.BrowseFilter = (OpcDa::browseFilter)BrowseFilterCTRL.Value;
