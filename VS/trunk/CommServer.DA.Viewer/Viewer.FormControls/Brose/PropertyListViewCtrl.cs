...
namespace CAS.Lib.OPCClientControlsLib
{
  ...
  public class PropertyListViewCtrl: System.Windows.Forms.UserControl
  {
    ...
    public PropertyListViewCtrl()
    {
      ...
      PropertiesLV.SmallImageList = ImageListLibrary.StaticProjectImageList;
    ...
    private void InitializeComponent()
    {
      ...
      this.PropertiesLV.ColumnClick += new ColumnClickEventHandler( SortHandler.listView_ColumnClick );
      // 
      // PopupMenu
      // 
    ...
    /// </summary>
    private OpcDa::BrowseElement m_element = null;
    ...
    private void AdjustColumns()
    {
      ...
      for ( int ii = 0; ii < PropertiesLV.Columns.Count; ii++ )
      {
        ...
        if ( empty )
          PropertiesLV.Columns[ ii ].Width = 0;
      }
